    ...
    render() {
        ...
        const chartDefinition =
            ...
            >
                ...
                >
                    <VictoryBar
                        data={[{ x: "District hospital", y: 100 }, { x: "Hospital", y: 30 }, { x: "Despensary", y: 89 }, { x: "Clinic", y: 89 }]}
                    />
                    <VictoryBar
                        data={[{ x: "District hospital", y: 60 }, { x: "Hospital", y: 70 }, { x: "Despensary", y: 45 }, { x: "Clinic", y: 26 }]}
                    />
                    <VictoryBar
                        data={[{ x: "District hospital", y: 40 }, { x: "Hospital", y: 50 }, { x: "Despensary", y: 29 }, { x: "Clinic", y: 49 }]}
                    />
                    <VictoryBar
                        data={[{ x: "District hospital", y: 20 }, { x: "Hospital", y: 65 }, { x: "Despensary", y: 39 }, { x: "Clinic", y: 53 }]}
                    />
                </VictoryGroup>
            </VictoryChart >
