...
class FacilityContactForm extends React.Component<Props> {
  ...
  initialValues = {
    ...
    latitude: this.props.fromAdd ? "" : this.props.current.geolocations.latitude
  };
  ...
  schema = yup.object().shape({
    ...
    catchmentPopulation: yup
      .number(this.INVALID_NM_MESSAGE)
      .positive()
      .integer()
      .required(this.REQUIRED_MESSAGE),
    longitude: yup
      .number(this.INVALID_NUM_MESSAGE)
      .positive()
      .required(this.REQUIRED_MESSAGE),
    latitude: yup
      .number(this.INVALID_NUM_MESSAGE)
  ...
  _onClick = async (onClose, values, setSubmitting, setErros, e) => {
    const endpoiint = this.props.fromAdd
      ? "contactDetails"
      : "updateContactDetails";
    const facilityId = this.props.fromAdd
      ? this.props.facility.id || 1
    ...
    return (
      <div className="container">
        ...
        {this.state.cancelForm &&
          !this.props.fromAdd && (
            <Redirect
              to={`/facilities/${this.props.match.params.id}/locations`}
            />
          )}
            ...
            <div>
              ...
              <Row>
                ...
                <Input
                  ...
                  onBlur={handleBlur}
                  error={
                    touched.catchmentPopulation && errors.catchmentPopulation
                  }
