    ...
    .then(values => {
        ...
        Facility.create(testData).then(resp => {
            ...
            describe("GET /Facilities", () => {
                it("should return facilities added", done => {
                    request
                        .get("/api/Facilities")
            ...
            describe("GET /Facilities/{id}/facilityType", () => {
                it("should fetch the correct facility type", done => {
                    request
                        .get("/api/Facilities/" + facilityId + "/facilityType")
                        .set("Accept", "application/json")
                        .expect(200)
                        .end((err, res) => {
            ...
            describe("PUT /Facilities", () => {
                it("should successfully edit a facility", done => {
                    request
                        ...
                        .expect(200)
                        .end((err, res) => {
                            res.body.facility_name.should.equal("Chitipa");
                            done();
                        });
                });
            });
            ...
            describe("GET /Facilities/{id}/owner", () => {
                it("should fetch the correct \
                                 facility owner", done => {
                    request
                        .get("/api/Facilities/" + facilityId + "/owner")
                        .set("Accept", "application/json")
                        .expect(200)
                        .end((err, res) => {
                            res.body.facility_owner.should.equal(
                                "Malawi Government"
                            );
                            done();
                        });
            ...
            describe("GET /Facilities/{id}/\
                ...
                it("should fetch the regulatory \
                    ...
                    request
                        ...
                        .expect(200)
                        .end((err, res) => {
                            res.body.facility_regulatory_status.should.equal(
                                "Registered"
                            );
                            done();
                        });
                ...
                describe("GET /Facilities/{id}/\
                    ...
                    it("should fetch the location \
                        ...
                        request
                            ...
                            .expect(200)
                            .end((err, res) => {
                                res.body.catchment_area.should.equal("Area 3");
                                done();
                            });
                    });
                });
            ...
            Promise.all([resource, utility, service]).then(res => {
                    ...
                    describe("GET /Facilities/{id}/\
                        ...
                        it("should fetch the resources \
                            ...
                            request
                                ...
                                .expect(200)
                                .end((err, res) => {
                                    res.body[0].resource_name.should.equal(
                                        "Computer"
                                    );
                                    done();
                                });
                ...
                FacilityUtility.create(facilityUtility).then(resp => {
                    describe("GET /Facilities/{id}/\
                                     utilities", () => {
                        it("should fetch the utilities of\
                            ...
                            request
                                ...
                                .expect(200)
                                .end((err, res) => {
                                    res.body[0].utility_name.should.equal(
                                        "ESCOM"
                                    );
                                    done();
                                });
                ...
                FacilityService.create(facilityService).then(resp => {
                    describe("GET /Facilities/{id}/\
                                     services", () => {
                        it("should fetch the services of\
                            ...
                            request
                                ...
                                .expect(200)
                                .end((err, res) => {
                                    res.body[0].service_name.should.equal(
                                        "Surgery"
                                    );
                                    done();
                                });
                ...
                FacilityAddress.create(facilityAddress).then(resp => {
                    describe("GET /Facilities/{id}/\
                                     addresses", () => {
                        it("should fetch the addresses of\
                            ...
                            request
                                ...
                                .expect(200)
                                .end((err, res) => {
                                    res.body.physical_address.should.equal(
