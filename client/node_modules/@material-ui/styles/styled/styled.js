...
function styled(Component) {
  var componentCreator = function componentCreator(style) {
    ...
    if (process.env.NODE_ENV !== 'production' && !name) {
      ...
      process.env.NODE_ENV !== "production" ? (0, _warning.default)(typeof classNamePrefix === 'string', ['Material-UI: the component displayName is invalid. It needs to be a string.', "Please fix the following component: ".concat(Component, ".")].join('\n')) : void 0;
    }
