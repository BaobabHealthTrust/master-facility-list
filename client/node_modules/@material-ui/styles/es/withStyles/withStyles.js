...
const withStyles = (stylesOrCreator, options = {}) => Component => {
  ...
  if (process.env.NODE_ENV !== 'production' && !name) {
    ...
    process.env.NODE_ENV !== "production" ? warning(typeof classNamePrefix === 'string', ['Material-UI: the component displayName is invalid. It needs to be a string.', `Please fix the following component: ${Component}.`].join('\n')) : void 0;
  }
