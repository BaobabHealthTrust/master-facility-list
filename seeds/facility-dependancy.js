    ...
    Promise.all([
      ...
      .then(values => {
        ...
        Promise.all([
          ...
          .then(values => {
            console.log(
              "All transport, beds, generator, housing and computer resources are created"
            );
            ...
            Promise.all([
              ...
              .then(values => {
                ...
                Promise.all([
                  ...
                  .then(values => {
                    console.log(
                      "All energy, water, waste disposal and network utilities are created"
                    );
                    ...
                    const serviceTypeReproductiveAndChild = {
                      service_type: "Reproductive and child Health Services",
                      description:
                        "These are reproductive and child health services",
                    };
                    ...
                    Promise.all([
                      ...
                      .then(values => {
                        ...
                        const serviceVaccination = Service.create(vaccinationData);
                        ...
                        Promise.all([
                          ...
                          .then(values => {
                            console.log(
                              "OPD, IPD, Therapeutics, Prosthetics, Nutrition, Reproductive and Child Health, community health and MCI services are created"
                            );
                            ...
                            const deliverysubData = [
                              {
                                ...
                                service_description:
                                  "This is neonatal resuscitation Service",
                                service_type_id: serviceTypeReproductiveAndChildId,
                            ...
                            Promise.all([
                              ...
                              .then(values => {
                                console.log(
                                  "ARI, community management, Radiology and Diarrhoea services are created"
                                );
                                ...
                                Promise.all([
                                  ...
                                  .then(values => {
                                    console.log(
                                      "ARI sub and diarrhoea services are created"
                                    );
