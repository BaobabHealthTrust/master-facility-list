...
Promise.all([facilityType, owner, operationalStatus, regulatoryStatus])
    .then(values => {
      ...
      , district, zone and regulatoryStatus are created"
        ...
        const resourceTypeHousingPromise = ResourceType.create(
            resourceTypeHousing
        );
                ...
                const transportData = [
                    {
                        ...
                        description:
                            "This facility has one ambulance that is operational",
                    ...
                    },
                    {
                        ...
                        description:
                            "This facility has no motor bike ambulances",
                        resource_type_id: resourceTypeTransportId
                    },
                    {
              ...
              computer resources are created"
                            ...
                            .then(values => {
                                ...
                                const energyData = [
                                    ...
                                    },
                                    {
                                        ...
                                        description:
                                            "This is wired electricity",
                                        utility_type_id: utilityTypeEnergyId
                                    },
                                    {
                                        utility_name: "Connected to ESCOM Grid",
                                        description:
                                            "This is connected to ESCOM grid",
                                        utility_type_id: utilityTypeEnergyId
                                    },
                                    {
                                ...
                                const utilityEnergy = Utility.create(
                                    energyData
                                );
                                ...
                                const waterData = [
                                    {
                                        utility_name:
                                            "Piped into health facility",
                                        description:
                                            "This is piped water into health facility",
                                        utility_type_id: utilityTypeWaterId
                                    },
                                    {
                                        utility_name:
                                            "Piped into facility ground",
                                        description:
                                            "This is piped water into facility ground",
                                        utility_type_id: utilityTypeWaterId
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        description:
                                            "This is Protected dug well",
                                        utility_type_id: utilityTypeWaterId
                                    },
                                    {
                                        utility_name: "Unprotected dug well",
                                        description:
                                            "This is unprotected dug well",
                                        utility_type_id: utilityTypeWaterId
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        description:
                                            "This is unprotected spring",
                                        utility_type_id: utilityTypeWaterId
                                    },
                                    {
                                        utility_name:
                                            "surface water(Dam/Lake/River/Pond",
                                ...
                                const wasteData = [
                                    ...
                                    },
                                    {
                                        ...
                                        description:
                                            "This is Toilet/pit latrine",
                                        utility_type_id: utilityTypeWasteDisposalId
                                    }
                                ];
                                const utilityWasteDisposal = Utility.create(
                                    wasteData
                                );
                                ...
                                const networkData = [
                                    ...
                                    },
                                    {
                                        ...
                                        description:
                                            "This is provided by skyband",
                                        utility_type_id: utilityTypeNetworkId
                                    },
                                    {
                                        utility_name: "Globe",
                                        description:
                                            "This is provided by globe",
                                        utility_type_id: utilityTypeNetworkId
                                    }
                                ];
                                const utilityNetwork = Utility.create(
                                    networkData
                                );
                      ...
                      network utilities are created"
                                        ...
                                        const serviceTypeTherapeutics = {
                                            ...
                                            description:
                                                "These are therapeutics services"
                                        };
                                        ...
                                        const serviceTypeProsthetics = {
                                            service_type:
                                                "Prosthetics and Medical Devices services",
                                            description:
                                        ...
                                        const serviceTypeCommunityHealth = {
                                            ...
                                            description:
                                                "These are community health services"
                                        };

                                        const serviceTypeCommunityHealthPromise = ServiceType.create(
                        ...
                        and child health services"
                                        ...
                                        const serviceTypeReproductiveAndChildPromise = ServiceType.create(
                                        ...
                                        Promise.all([
                                            ...
                                            .then(values => {
                                                const serviceTypeClinicalId =
                                                    values[0].id;
                                                const opdData = {
                                                    service_name:
                                                        "Out patient services (OPD)",
                                                    service_description:
                                                        "This is out patient Service",
                                                    service_type_id: serviceTypeClinicalId,
                                                    service_category_id: 0
                                                };

                                                const serviceOpd = Service.create(
                                                    opdData
                                                );
                                                const ipdData = {
                                                    service_name:
                                                    ...
                                                    service_description:
                                                        "This is in patient Service",
                                                    service_type_id: serviceTypeClinicalId,
                                                    service_category_id: 0
                                                };

                                                const serviceIpd = Service.create(
                                                    ipdData
                                                );
                                                const mciData = {
                                                    service_name:
                                                ...
                                                const serviceMci = Service.create(
                                                    mciData
                                                );
                                                const serviceTypeTherapeuticsId =
                                                    values[1].id;
                                                ...
                                                const serviceTypeProstheticsId =
                                                    values[2].id;
                                                ...
                                                const malariaData = {
                                                    ...
                                                    service_description:
                                                        "This is malaria service",
                                                    service_type_id: serviceTypeClinicalId,
                                                    service_category_id: 0
                                                };
                                                const serviceMalaria = Service.create(
                                                    malariaData
                                                );
                                                const serviceTypeNutritionId =
                                                    values[3].id;
                                                const nutritionData = [
                                                    {
                                                        service_name:
                              ...
                              in infants and children 6-59 months service",
                                                ...
                                                const serviceNutrition = Service.create(
                                                    nutritionData
                                                );
                                                const serviceTypeCommunityHealthId =
                                                    values[4].id;
                                                const communityData = [
                                                    {
                                                        service_name:
                                                ...
                                                const serviceCommunity = Service.create(
                                                    communityData
                                                );
                                                const serviceTypeReproductiveAndChildId =
                                                    values[5].id;
                                                ...
                                                const antenatalData = {
                                                    service_name:
                                                        "Ante-natal Services",
                                                    service_description:
                                                        "This is  ante-natal service",
                                                    service_type_id: serviceTypeReproductiveAndChildId,
                                                    service_category_id: 0
                                                };
                                                const serviceAntenatal = Service.create(
                                                    antenatalData
                                                );
                                                const deliveryData = {
                                                    service_name:
                                                ...
                                                const serviceDelivery = Service.create(
                                                    deliveryData
                                                );
                                                const serviceTypeVaccinationId =
                                                    values[6].id;
                                                ...
                                                const radiologyData = {
                                                    ...
                                                    service_description:
                                                        "This is  radiology service",
                                                    service_type_id: serviceTypeDiagnosticId,
                                                    service_category_id: 0
                                                };
                                                const serviceRadiology = Service.create(
                                                    radiologyData
                                                );
                              ...
                              services are created"
                                                        ...
                                                        const serviceAri = Service.create(
                                                            ariData
                                                        );
                                                        const diarrhoeaData = {
                                                            service_name:
                                ...
                                provider",
                                                        ...
                                                        const serviceCommunityMicronutrient = Service.create(
                                ...
                                Vitamin A",
                                                        ...
                                                        const serviceCommunityVitaminA = Service.create(
                                                        ...
                                                        const slideData = {
                                                            service_name:
                                                                "Slide Microscopy",
                                                            service_description:
                                                                "This is a slice microscopy",
                                                            service_type_id: serviceTypeClinicalId,
                                                            service_category_id: malariaId
                                                        };
                                                        const serviceSlide = Service.create(
                                                            slideData
                                                        );
                                                        const rapidData = {
                                                            service_name:
                                                        ...
                                                        const serviceRapid = Service.create(
                                                            rapidData
                                                        );
                                                        const rdtsData = {
                                                            service_name:
                                                                "RDTs for under-5",
                                                            service_description:
                                                                "This is RDTs for under-5",
                                                            service_type_id: serviceTypeClinicalId,
                                                            service_category_id: malariaId
                                                        };
                                                        const serviceRdts = Service.create(
                                                            rdtsData
                                                        );
                                                        const firstlineData = {
                                                            service_name:
                                                        ...
                                                        const serviceTocm = Service.create(
                                                            tocmData
                                                        );
                                                        const familyplanningId =
                                                            values[8].id;
